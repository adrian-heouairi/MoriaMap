 ...
 * geographic position with the selected optimization method. If walking is more optimal, the route
 * returned may include walking sections.
 */
public class OptimizedRouteBetweenPositionsWithWalkQuery
    extends OptimizedRouteBetweenPositionsQuery {
   ...
   */
  public OptimizedRouteBetweenPositionsWithWalkQuery(
      OutputStream out,
  ...
  protected void pre(TransportNetwork network) {
    for (Stop stop : network.getStops()) this.addWalkSegments(network, stop);
  }
}
