...
public class StopNameFinder {
   ...
   * @return the cost of substitution, which is 0 if the two characters are the same, and 1
   *     otherwise
   */
   ...
   * @return the minimum number of insertions, deletions, and substitutions needed to transform x
   *     into y
   */
