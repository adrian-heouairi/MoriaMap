...
public class TransportSegment extends Edge {
   ...
   */
  public static TransportSegment from(
      Stop from,
      Stop to,
      String lineName,
      String variantName,
   ...
   *
   * <p>Two transport segment are equal if they have the same from, the same to, lineVariantName,
   * the same distance and the same travelDuration
   *
  ...
  public boolean equals(Object object) {
    ...
    return (this.getFrom()).equals(other.getFrom())
        ...
        && this.lineName.equals(other.lineName)
        && this.variantName.equals(other.variantName)
        && this.distance == other.distance
        && this.travelDuration.equals(other.travelDuration);
  }
