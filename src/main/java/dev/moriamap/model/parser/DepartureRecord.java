...
/**
 * Holds the data that represents the departure time of transport from the starting terminus of a
 * certain variant in a line.
 */
public record DepartureRecord(
    String lineName, String terminusName, LocalTime departureTime, String variantName) {

  /** The size of a String tuple corresponding to a DepartureRecord. */
  public static final int VALID_TUPLE_SIZE = 4;

  /** The index of the Line name value in a String tuple corresponding to a DepartureRecord. */
  public static final int LINE_NAME_TUPLE_INDEX = 0;

  /** The index of the terminus name value in a String tuple corresponding to a DepartureRecord. */
  public static final int TERMINUS_NAME_TUPLE_INDEX = 1;

  /** The index of the departure time value in a String tuple corresponding to a DepartureRecord. */
  public static final int DEPARTURE_TIME_TUPLE_INDEX = 2;

  /** The index of the Variant name value in a String tuple corresponding to a DepartureRecord. */
  public static final int VARIANT_NAME_TUPLE_INDEX = 3;

  /**
   * Record constructor specifying Line name, terminus name, time and Variant name.
   *
  ...
  /**
   * {@return a DepartureRecord corresponding to the data in the given tuple} Throws
   * DateTimeParseException if the departure time value cannot be parsed.
   *
   * @param tuple data as a String tuple
   * @throws NullPointerException if tuple is null
   * @throws IllegalArgumentException if the size of tuple is different from VALID_TUPLE_SIZE
   */
  public static DepartureRecord fromTuple(List<String> tuple) {
    ...
    String timeCorrectFormat =
        String.format("%02d", Integer.parseInt(timeArray[0])) + ":" + timeArray[1];
  ...
  /**
   * Returns a list of DepartureRecords corresponding to the data given as a list of String tuples.
   * Throws DateTimeParseException if the departure time value cannot be parsed.
   *
   * @param tuples a list of tuples corresponding to DepartureRecords as String tuples
   * @return the corresponding list of DepartureRecords
   * @throws NullPointerException if tuples or one of the tuples is null
   * @throws IllegalArgumentException if the size of one or more of the tuples in tuples is not
   *     VALID_TUPLE_SIZE
   */
