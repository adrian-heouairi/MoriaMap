...
class VariantTest {
  ...
  @Test
  void emptyVariantWithNullLineThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> Variant.empty("1", null));
  }

  @Test
  void emptyVariantWithNullNameThrowsException() {
    assertThrows(IllegalArgumentException.class, () -> Variant.empty(null, "14"));
  }

  @Test
  void variantsHavingSameIdAndLinesWithSameReferencesAreEqual() {
    Variant v = Variant.empty("1", "14");
  ...
  @Test
  void variantNotEqualToNull() {
    Variant v = Variant.empty("1", "14");
    assertNotEquals(null, v);
  }

  @Test
  void variantsHavingSameIdAndSameLineNameAndSameTransportSegmentsAreEqual() {
  ...
  @Test
  void variantsHavingSameIdAndSameLineNameAndDifferentTransportSegmentsAreNotEqual() {
    Variant v = Variant.empty("Variant 1", "14");
    Variant v1 = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
  ...
  @Test
  void variantsHavingSameIdAndSameLineNameAndDifferentTransportSegmentsSizeAreNotEqual() {
    Variant v = Variant.empty("Variant 1", "14");
    Variant v1 = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
  ...
  @Test
  void addANotConcordingTransportSegmentLineName() {
    Variant v = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
    TransportSegment ts = TransportSegment.from(s1, s2, "13", "Variant 1", Duration.ZERO, 0.0);
    assertThrows(IllegalArgumentException.class, () -> v.addTransportSegment(ts));
  }

  @Test
  void addANotConcordingTransportSegmentVariantName() {
    Variant v = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
  ...
  @Test
  void variantsWithDifferentTrainDepartureSizeAreNotEqual() {
    Variant v = Variant.empty("1", "14");
    Variant v1 = Variant.empty("1", "14");
  ...
  @Test
  void variantsWithDifferentTrainDepartureAreNotEqual() {
    Variant v = Variant.empty("1", "14");
    Variant v1 = Variant.empty("1", "14");
    LocalTime t1 = LocalTime.of(0, 0);
    LocalTime t2 = LocalTime.of(1, 0);
  ...
  @Test
  void variantIsEqualToItself() {
    Variant v = Variant.empty("1", "13");
    assertEquals(v, v);
  }

  @Test
  void variantInstanceIsNotEqualToNull() {
    Variant v = Variant.empty("1", "14");
    assertNotEquals(null, v);
  }

  @Test
  void objectIsNotEqualToVariant() {
    Object o = new Object();
  ...
  @Test
  void variantsWithDifferentIdAndSameLineAreNotEqual() {
  ...
  @Test
  void variantOfSameIdInDifferentLinesAreNotEqual() {
  ...
  @Test
  void variantHasNoTransportSegmentAtCreation() {
    Variant v = Variant.empty("1", "14");
  ...
  @Test
  void addANullTransportSegmentThrowsException() {
    Variant v = Variant.empty("1", "14");
    assertThrows(IllegalArgumentException.class, () -> v.addTransportSegment(null));
  }

  @Test
  void addATransportSegmentToVariant() {
    Variant v = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
    TransportSegment ts = TransportSegment.from(s1, s2, "14", "Variant 1", Duration.ZERO, 0.0);
  ...
  @Test
  void addingTwiceTheSameTransportSegmentReturnFalse() {
    Variant v = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
    TransportSegment ts = TransportSegment.from(s1, s2, "14", "Variant 1", Duration.ZERO, 0.0);
  ...
  @Test
  void addNullTimeToVariantThrowsException() {
    Variant v = Variant.empty("1", "14");
    assertThrows(IllegalArgumentException.class, () -> v.addDeparture(null));
  }

  @Test
  void addingTwiceTheSameTimeToVariantReturnFalse() {
    Variant v = Variant.empty("1", "14");
    LocalTime t = LocalTime.of(0, 0);
    v.addDeparture(t);
  ...
  @Test
  void hashCodeOfSemanticallyEqualVariantsAreEqual() {
    Variant v1 = Variant.empty("Variant 1", "14");
  ...
  @Test
  void hasStopThrowsExceptionWithNullArgument() {
    Variant sut = newVariantHelper();
    assertThrows(IllegalArgumentException.class, () -> sut.hasStop(null));
  }

  @Test
  void hasStopReturnsFalseWhenStopIsAbsent() {
    Variant sut = newVariantHelper();
  ...
  @Test
  void hasStopReturnsFalseWhenStopIsAbsentWithOtherSegments() {
    ...
    TransportSegment ts =
        TransportSegment.from(
            s1, s2, "Papier 80g", "A4", Duration.ZERO, 45.0 // FTL
            );
  ...
  @Test
  void hasStopReturnsTrueWhenStopIsPresentInGetTo() {
    Variant sut = Variant.empty("A4", "Papier 80g");
    Stop s1 = Stop.from("Clairefontaine", GeographicPosition.NULL_ISLAND);
    Stop s2 = Stop.from("Otail", GeographicPosition.NORTH_POLE);
    TransportSegment ts =
  ...
  @Test
  void hasStopReturnsTrueWhenStopIsPresentInGetFrom() {
    Variant sut = Variant.empty("A4", "Papier 80g");
    Stop s1 = Stop.from("Clairefontaine", GeographicPosition.NULL_ISLAND);
    Stop s2 = Stop.from("Otail", GeographicPosition.NORTH_POLE);
    TransportSegment ts =
        TransportSegment.from(
            s2, s1, "Papier 80g", "A4", Duration.ZERO, 45.0 // FTL
            );
    sut.addTransportSegment(ts);
    assertTrue(sut.hasStop(s2));
  }
  ...
  @Test
  void hasOutgoingSegmentThrowsExceptionWhenStopIsNull() {
    Variant sut = Variant.empty("Asus", "Acer");
    assertThrows(IllegalArgumentException.class, () -> sut.hasOutgoingSegment(null));
  }

  @Test
  void hasOutgoingSegmentReturnsFalseWhenStopIsAbsent() {
  ...
  @Test
  void hasOutgoingSegmentReturnsTrueWhenStopHasOutgoingSegment() {
    Variant sut = newVariantHelper();
  ...
  @Test
  void getOutgoingSegmentThrowsExceptionWhenStopIsNull() {
    Variant sut = newVariantHelper();
    assertThrows(IllegalArgumentException.class, () -> sut.getOutgoingSegment(null));
  }

  @Test
  void getOutgoingSegmentThrowsExceptionWhenStopHasNoOutgoingEdge() {
    Variant sut = newVariantHelper();
    Stop dummy = Stop.from("Null Island", GeographicPosition.NULL_ISLAND);
    assertThrows(NoSuchElementException.class, () -> sut.getOutgoingSegment(dummy));
  }

  @Test
  void getOutgoingSegmentReturnsOutgoingSegment() {
    Variant sut = newVariantHelper();
  ...
  @Test
  void travelTimeWithNullArgumentThrowsException() {
    Variant sut = Variant.empty("v", "l");
    assertThrows(IllegalArgumentException.class, () -> sut.getTravelTimeTo(null));
  }

  @Test
  void travelTimeWithoutOutgoingSegmentThrowsException() {
    ...
    TransportSegment ts1 =
        TransportSegment.from(start, s1, "ligne", "variant", Duration.ofMinutes(42), 42.0);
    TransportSegment ts2 =
        TransportSegment.from(s2, end, "ligne", "variant", Duration.ofMinutes(42), 41.99);
    sut.addTransportSegment(ts1);
    sut.addTransportSegment(ts2);
    assertThrows(NoSuchElementException.class, () -> sut.getTravelTimeTo(end));
  }

  @Test
  void travelTimeOfVariantWithOneSegmentEqualsDurationOfSegment() {
    Variant sut = Variant.empty("variant", "ligne");
    Stop from = Stop.from("from", GeographicPosition.at(32, 42));
    Stop to = Stop.from("to", GeographicPosition.at(45, 23));
    TransportSegment ts =
        TransportSegment.from(from, to, "ligne", "variant", Duration.ofMinutes(42), 42.0);
    sut.addTransportSegment(ts);
    assertEquals(ts.getTravelDuration(), sut.getTravelTimeTo(to));
  }

  @Test
  void travelTimeOfVariantFromStartToEndEqualsSumOfSegmentDurations() {
    Variant sut = Variant.empty("v", "l");
  ...
  @Test
  void getStopsReturnTheOrderedListOfStop() {
    Variant v = Variant.empty("Variant 1", "14");
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
    Stop s3 = Stop.from("s3", GeographicPosition.SOUTH_POLE);
