...
class StopTest {
  @Test
  void stopConstructorTest() {
    Stop s = Stop.from("test", GeographicPosition.NULL_ISLAND);
    assertEquals("test", s.getName());
  }

  @Test
  void stopInstanceIsEqualToItselfTest() {
  ...
  @Test
  void hashCodeOfSemanticallyEqualStopsAreEqual() {
    Stop v = Stop.from("Stop", GeographicPosition.at(15.59, 18.43));
  ...
  @Test
  void stopsWithDifferentNamesAreNotEqual() {
  ...
  @Test
  void stopsWithDifferentCoordinatesAndDifferentNamesAreNotEqual() {
  ...
  @Test
  void stopsWithDifferentCoordinatesAndDifferentNamesAndLatitudeAreNotEqual() {
  ...
  @Test
  void stopsWithDifferentCoordinatesAndDifferentNamesAndLongitudeAreNotEqual() {
  ...
  @Test
  void stopIsNotEqualToNull() {
    Stop v = Stop.from("Stop", GeographicPosition.at(18.59, 18.43));
    assertNotEquals(null, v);
  }

  @Test
  void semanticallyEqualStopsAreEqual() {
    Stop v = Stop.from("Stop", GeographicPosition.at(18.59, 18.42));
