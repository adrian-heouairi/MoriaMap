...
class TransportNetworkTest {
  ...
  void getStopFromPositionThrowsException() {
    ...
    assertThrows(IllegalArgumentException.class, () -> tn.getStopFromPosition(null));
  }

  @Test
  void getStopByNameThrowsException() {
    TransportNetwork tn = TransportNetwork.empty();
    assertThrows(IllegalArgumentException.class, () -> tn.getStopByName(null));
  }

  @Test
  void addLineThrowsException() {
    TransportNetwork tn = TransportNetwork.empty();
    assertThrows(IllegalArgumentException.class, () -> tn.addLine(null));
  }

  @Test
  void findStopThrowsException() {
    TransportNetwork tn = TransportNetwork.empty();
    assertThrows(IllegalArgumentException.class, () -> tn.findStop(null));
  }

  @Test
  void findLineThrowsException() {
    TransportNetwork tn = TransportNetwork.empty();
    assertThrows(IllegalArgumentException.class, () -> tn.findLine(null));
  }
  ...
  private TransportNetwork newTransportNetworkHelper() {
    ...
    TransportSegment ts1 = TransportSegment.from(s1, s2, "7B", "1", Duration.ofMinutes(3), 4);
    TransportSegment ts2 = TransportSegment.from(s2, s1, "7B", "2", Duration.ofMinutes(4), 4);
  ...
  void addTransportSegment() {
    ...
    Stop s1 = Stop.from("s1", GeographicPosition.SOUTH_POLE);
    Stop s2 = Stop.from("s2", GeographicPosition.NORTH_POLE);
    TransportSegment ts1 = TransportSegment.from(s1, s2, "7B", "1", Duration.ZERO, 4);
  ...
  void getPassagesAtStop() {
    ...
    TransportSegment ts = TransportSegment.from(s1, s2, "7B", "1", Duration.ZERO, 4);
  ...
  void getRouteDescriptionTestThrowException() {
    ...
    route.add(ts1);
    route.add(ts2);
    assertThrows(IllegalStateException.class, () -> tn.getRouteDescription(route, LocalTime.MIN));
  }
  ...
  void addDepartureToVariantThrowExceptionWithNullArgTest() {
    var tn = newTransportNetworkHelper();
    assertThrows(
        IllegalArgumentException.class, () -> tn.addDepartureToVariant(null, "1", LocalTime.MIN));
    assertThrows(
        IllegalArgumentException.class, () -> tn.addDepartureToVariant("14", null, LocalTime.MIN));
    assertThrows(IllegalArgumentException.class, () -> tn.addDepartureToVariant("14", "1", null));
  }
  ...
  void addGeographicVertexTrue() {
    TransportNetwork tn = TransportNetwork.empty();
    GeographicVertex geoVertex = GeographicVertex.at(GeographicPosition.NORTH_POLE);
  ...
  void addGeographicVertexNull() {
    TransportNetwork tn = TransportNetwork.empty();
    assertThrows(NullPointerException.class, () -> tn.addGeographicVertex(null));
  }
  ...
  void removeGeographicVertexNoSuchElement() {
    ...
    assertThrows(NoSuchElementException.class, () -> tn.removeGeographicVertex(geoVertex));
  }
  ...
  void addWalkSegmentTrue() {
    ...
    GeographicVertex geoVertex1 = GeographicVertex.at(GeographicPosition.NORTH_POLE);
    GeographicVertex geoVertex2 = GeographicVertex.at(GeographicPosition.SOUTH_POLE);
  ...
  void addWalkSegmentNull() {
    TransportNetwork tn = TransportNetwork.empty();
    assertThrows(IllegalArgumentException.class, () -> tn.addWalkSegment(null));
  }
  ...
  void removeWalkSegmentNull() {
    ...
    assertThrows(NullPointerException.class, () -> tn.removeWalkSegment(null));
  }
}
