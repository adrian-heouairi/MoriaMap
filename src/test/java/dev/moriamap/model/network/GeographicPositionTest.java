...
class GeographicPositionTest {
  ...
  @Test
  void latitudeOfNullIslandIs0() {
    GeographicPosition sut = GeographicPosition.NULL_ISLAND;
    assertEquals(0.0, sut.getLatitude());
  }

  @Test
  void longitudeOfNullIslandIs0() {
    GeographicPosition sut = GeographicPosition.NULL_ISLAND;
    assertEquals(0.0, sut.getLongitude());
  }

  @Test
  void latitudeOfGPAtLatitude5Is5() {
    GeographicPosition sut = GeographicPosition.at(5.0, 0.0);
    assertEquals(5.0, sut.getLatitude());
  }

  @Test
  void longitudeOfGPAtLongitude42Is42() {
    GeographicPosition sut = GeographicPosition.at(18.39, 42.0);
    assertEquals(42.0, sut.getLongitude());
  }

  @Test
  void latitudeOf180DegreesThrowsIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class, () -> GeographicPosition.at(180.0, 42.0));
  }

  @Test
  void latitudeOfMinus91DegreesThrowsIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class, () -> GeographicPosition.at(-91.5, 42.0));
  }

  @Test
  void longitudeOfMinus181DegreesThrowsIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class, () -> GeographicPosition.at(42.0, -181.0));
  }

  @Test
  void longitudeOf281DegreesThrowsIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class, () -> GeographicPosition.at(42.0, 281.4));
  }

  @Test
  void cartesianCoordinatesOfNullIslandIsOnEarthAreRt_0_0() {
  ...
  @Test
  void cartesianCoordinatesOfNorthPoleOnEarthAre0_0_Rt() {
  ...
  @Test
  void cartesianCoordinatesOfSouthPoleOnEarthAre0_0_MinusRt() {
  ...
  @Test
  void negativeRadiusForCartesianCoordinatesThrowsException() {
    GeographicPosition point = GeographicPosition.at(-42.0, 142.0);
    assertThrows(IllegalArgumentException.class, () -> point.toCartesian(-0.0));
  }

  @Test
  void euclideanDistanceBetweenSameGPIs0() {
    GeographicPosition point = GeographicPosition.at(-42.0, -42.0);
    double res =
        GeographicPosition.euclideanDistance(point, point, GeographicPosition.EARTH_RADIUS);
    assertEquals(0.0, res);
  }

  @Test
  void euclideanDistanceBetweenNorthAndSouthPoleIsTwiceEarthRadius() {
    GeographicPosition northPole = GeographicPosition.NORTH_POLE;
    GeographicPosition southPole = GeographicPosition.SOUTH_POLE;
    double distance = GeographicPosition.EARTH_RADIUS;
    assertEquals(
        2 * distance, GeographicPosition.euclideanDistance(northPole, southPole, distance));
  }

  @Test
  void euclideanDistanceWithNegativeRadiusThrowsException() {
    GeographicPosition p1 = GeographicPosition.at(32.0, 42.0);
    GeographicPosition p2 = GeographicPosition.at(42.0, 15.0);
    assertThrows(
        IllegalArgumentException.class, () -> GeographicPosition.euclideanDistance(p1, p2, -0.0));
  }

  @Test
  void distanceFromNorthPoleToSouthPoleIsTwiceTheEarthRadius() {
    GeographicPosition northPole = GeographicPosition.NORTH_POLE;
    GeographicPosition southPole = GeographicPosition.SOUTH_POLE;
    double distance = GeographicPosition.EARTH_RADIUS;
  ...
  @Test
  void hashCodeOfEqualObjectIsEqual() {
    GeographicPosition p1 = GeographicPosition.at(43.352, 59.435);
    GeographicPosition p2 = GeographicPosition.at(43.352, 59.435);
    assertTrue(p1.hashCode() == p2.hashCode() && p1.equals(p2) && p2.equals(p1));
  }

  @Test
  void differentLongitudeOfGPsMakesThemNotEqual() {
  ...
  @Test
  void differentLatitudeOfGPsMakesThemNotEqual() {
  ...
  @Test
  void readTwoStringSameFormatDecimal() {
  ...
  @Test
  void readTwoStringSameFormatDegree() {
  ...
  @Test
  void readTwoStringDifferentFormat() {
  ...
  @Test
  void fromReadNull() {
    assertThrows(IllegalArgumentException.class, () -> GeographicPosition.from(null, "2.25"));
  }

  @Test
  void fromWrongFormat() {
    assertThrows(IllegalArgumentException.class, () -> GeographicPosition.from("2.75 We", "2.25"));
  }
}
