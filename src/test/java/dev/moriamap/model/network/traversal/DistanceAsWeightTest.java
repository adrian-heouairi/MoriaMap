...
class DistanceAsWeightTest {
  ...
  static class DummyEdge extends Edge {
    public DummyEdge(DummyVertex from, DummyVertex to) {
      super(from, to);
    }
  }

  @Test
  void distanceAsWeightOfEdgeDifferentThanTSThrowsException() {
    ...
    assertThrows(UnsupportedOperationException.class, () -> sut.apply(34.0, edge));
  }

  @Test
  void dawOfNullEdgeThrowsException() {
    var sut = new DistanceAsWeight(TransportNetwork.empty());
    assertThrows(NullPointerException.class, () -> sut.apply(42.0, null));
  }

  @Test
  void dawOfNullCurrentThrowsException() {
    var e = new DummyEdge(new DummyVertex(), new DummyVertex());
    var sut = new DistanceAsWeight(TransportNetwork.empty());
    assertThrows(NullPointerException.class, () -> sut.apply(null, e));
  }

  @Test
  void dawOfEdgeReturnsTransportSegmentDistance() {
  ...
  @Test
  void dawOfWalkSegmentReturnsDistanceTimesDrudgery() {
    var sut = new DistanceAsWeight(TransportNetwork.empty());
    ...
    assertEquals(ws.distance * WalkSegment.WALK_DRUDGERY / 1000.0, sut.apply(0.0, ws));
  }
}
