...
class TravelTimeAsWeightTest {
  ...
  void nullStartTimeArgTest() {
    ...
    assertThrows(IllegalArgumentException.class, () -> new TravelTimeAsWeight(null, tn));
  }

  @Test
  void nullNetworkArgTest() {
    assertThrows(IllegalArgumentException.class, () -> new TravelTimeAsWeight(LocalTime.MIN, null));
  }
  ...
  void applyThrowUnsupportedOperationExceptionTest() {
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> travelTimeAsWeight.apply(0.0, dummyEdge));
  }
  ...
  void applyTestWalkSegment() {
    ...
    TransportNetwork tn = TransportNetwork.empty();
    tn.addWalkSegment(ws);
    var travelTimeAsWeight = new TravelTimeAsWeight(LocalTime.MIN, tn);
    assertEquals(2.29356E7, travelTimeAsWeight.apply(0.0, ws));
  }
}
