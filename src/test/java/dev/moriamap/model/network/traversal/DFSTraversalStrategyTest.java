...
class DFSTraversalStrategyTest {
  ...
  private static class DummyGraph extends Graph {
    ...
    void addDummyVertex(DummyVertex dv) {
      super.addVertex(dv);
    }
  }
  ...
  @Test
  void traversalWithAbsentSourceThrowsException() {
    var graph = new DummyGraph();
    var absent = new DummyVertex();
    assertThrows(NoSuchElementException.class, () -> graph.traversal(absent, null, null, false));
  }

  @Test
  void dsfInGraphWithOnlySourceReturnsEmtpyMap() {
    var graph = new DummyGraph();
    var src = new DummyVertex();
  ...
  @Test
  void dfsInGraphWithOneEdgeReturnsMapWithOneEntry() {
  ...
  @Test
  void dfsTraversalContainsExpectedKeys() {
    var graph = new DummyGraph();
  ...
  @Test
  void dfsTraversalStopsWhenDestinationIsFound() {
    var graph = new DummyGraph();
    var v1 = new DummyVertex();
    var v2 = new DummyVertex();
    var v3 = new DummyVertex();
  ...
  @Test
  void dfsTraversalIsEmptyIfSrcEqualsDstAndFlagIsTrue() {
    var graph = new DummyGraph();
    var v1 = new DummyVertex();
    var v2 = new DummyVertex();
    var v3 = new DummyVertex();
  ...
  @Test
  void dfsWhenSrcEqualsDestAndFlagFalseReturnsCompleteTraversal() {
    var graph = new DummyGraph();
    var v1 = new DummyVertex();
    var v2 = new DummyVertex();
    var v3 = new DummyVertex();
