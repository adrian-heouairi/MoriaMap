...
class TransportNetworkParserTest {
  @Test
  void testNumberOfTransportLine() throws InconsistentCSVException {
    InputStream resource =
        TransportNetworkParserTest.class.getResourceAsStream("/test_map_data.csv");
    TransportNetwork tn = TransportNetworkParser.generateFrom(resource);
    assertEquals(3, tn.getLines().size());
  }

  @Test
  void testNumberOfVariant() throws InconsistentCSVException {
  ...
  @Test
  void findLineNameEqualTrue() throws InconsistentCSVException {
    InputStream resource =
        TransportNetworkParserTest.class.getResourceAsStream("/test_map_data.csv");
  ...
  @Test
  void findLineObjectEqualFalse() throws InconsistentCSVException {
    InputStream resource =
        TransportNetworkParserTest.class.getResourceAsStream("/test_map_data.csv");
  ...
  @Test
  void findStopObjectEqualtrue() throws InconsistentCSVException {
    InputStream resource =
        TransportNetworkParserTest.class.getResourceAsStream("/test_map_data.csv");
    TransportNetwork tn = TransportNetworkParser.generateFrom(resource);
