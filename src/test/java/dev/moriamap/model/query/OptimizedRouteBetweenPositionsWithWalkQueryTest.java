...
class OptimizedRouteBetweenPositionsWithWalkQueryTest {
    ...
    try {
      tn =
          TransportNetworkParser.generateFrom(
              OptimizedRouteBetweenPositionsWithWalkQueryTest.class.getResourceAsStream(
                  "/test_map_data.csv"));
  ...
  void startingPointIsAStop() {
    ...
    OptimizedRouteBetweenPositionsWithWalkQuery query =
        new OptimizedRouteBetweenPositionsWithWalkQuery(
            null,
