...
class QueryTest {
  ...
  private static class DummyQuery extends Query {
    ...
    public String run(TransportNetwork network) throws QueryFailureException {
      if (in.equals("notAllowed")) throw new QueryFailureException("Input can't be 'notAllowed'");
      return "yes";
    }
  }
