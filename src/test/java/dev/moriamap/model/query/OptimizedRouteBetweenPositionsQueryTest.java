...
class OptimizedRouteBetweenPositionsQueryTest {
    ...
    try {
      tn =
          TransportNetworkParser.generateFrom(
              OptimizedRouteBetweenPositionsQueryTest.class.getResourceAsStream(
                  "/test_map_data.csv"));
      InputStream timetablesInputStream =
          OptimizedRouteBetweenPositionsQueryTest.class.getResourceAsStream("/test_timetables.csv");
  ...
  @Test
  void startingPointIsAStop() {
    // Coordinates of Lourmel

    OptimizedRouteBetweenPositionsQuery query =
        new OptimizedRouteBetweenPositionsQuery(
            null,
